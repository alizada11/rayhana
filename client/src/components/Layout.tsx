...
export default function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className={cn("min-h-screen flex flex-col font-sans", isRTL ? "font-vazir" : "font-poppins")}>
      {/* Header */}
                ...
                <Link key={item.href} href={item.href}>
                  <a 
                    className={cn(
                      ...
                      location === item.href ? "text-primary bg-muted" : "text-foreground"
                    )}
        ...
        <div className="container py-8 md:py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              <h3 className="font-serif text-xl font-bold text-primary mb-4">RAYHANA</h3>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li className="flex gap-4 mt-4">
                  <a href="https://www.instagram.com/rayhanafamily?igsh=Z2pmOWtlOXE2NTR6&utm_source=qr" target="_blank" rel="noopener noreferrer" className="hover:text-primary">Instagram</a>
                  <a href="https://www.facebook.com/profile.php?id=61583243074253" target="_blank" rel="noopener noreferrer" className="hover:text-primary">Facebook</a>
                </li>
              </ul>
            </div>
          </div>
